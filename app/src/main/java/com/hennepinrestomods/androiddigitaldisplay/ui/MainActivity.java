...
public class MainActivity extends RoboActivity implements ObdProgressListener {
    ...
    private ArrayList<ImageSpeedometer> gauges = new ArrayList<>();
        ...
        public void run() {
            if (service != null && service.isRunning() && service.queueEmpty()) {
                ...
                if (prefs.getBoolean(ConfigActivity.UPLOAD_DATA_KEY, false)) {
                    ...
                    new MainActivity.UploadAsyncTask().execute(reading);
    ...
    */
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        oilTemperature = findViewById(R.id.oilpressuregauge);
        waterTemperature = findViewById(R.id.temperaturegauge);
        ...
        ok.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                for(ImageSpeedometer gauge : gauges){
                    gauge.speedTo(seekbar.getProgress());
                }
            }
        });
        ...
        withTremble.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                for(ImageSpeedometer gauge : gauges){
                    gauge.setWithTremble(isChecked);
                }
            }
        });
