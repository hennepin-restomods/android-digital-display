package com.hennepinrestomods.androiddigitaldisplay.obd;
...
import com.hennepinrestomods.androiddigitaldisplay.ui.RequestActivity;
...
public class ObdController {
    ...
    private TroubleCodesTask tct;

    public ObdController(Handler mHandler, RequestActivity requestActivity) {
        this.requestActivity = requestActivity;
        this.mHandler = mHandler;
        tct = new TroubleCodesTask();
    }
    ...
    private class TroubleCodesTask extends AsyncTask<String, Integer, String> {
        @Override
